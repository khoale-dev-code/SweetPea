    ...
    <>
      <section id="about" className="paper-texture border-y border-[#d7d1bf] py-20 sm:py-24">
        <div className="container-shell grid gap-8 lg:grid-cols-[.9fr_1.1fr] lg:items-center">
          <div className="rounded-[2.5rem] bg-[#184d39] p-7 text-white sm:p-10">
            <span className="grid h-12 w-12 place-items-center rounded-full bg-[#c7db95] text-[#184d39]">
              <Sprout size={23} />
            </span>
          ...
          <div className="px-1 py-4 lg:px-10">
            ...
            <div className="mt-8 grid grid-cols-2 gap-4">
              <div className="rounded-3xl border border-[#d7d1bf] bg-white/65 p-5">
                <p className="font-display text-3xl font-semibold text-[#184d39]">2022</p>
                <p className="mt-1 text-sm text-[#68766e]">Năm Sweet Pea bắt đầu</p>
              </div>
              <div className="rounded-3xl border border-[#d7d1bf] bg-white/65 p-5">
                <p className="font-display text-3xl font-semibold text-[#184d39]">Mỗi ngày</p>
      ...
      <section id="contact" className="bg-[#c7db95] py-20 sm:py-24">
        <div className="container-shell grid gap-8 lg:grid-cols-[1fr_.9fr]">
          <div>
            ...
            <h2 className="font-display mt-3 max-w-xl text-4xl font-semibold tracking-[-0.045em] text-[#184d39] sm:text-6xl">
          ...
          <div className="rounded-[2.25rem] border border-[#c7db95] bg-[#fffced] p-5 shadow-[0_20px_55px_rgba(50,77,62,0.09)] sm:p-7">
            <div className="grid gap-3">
              <a href={`tel:${shop.phone.replace(/\s/g, "")}`} className="focus-ring flex min-h-14 items-center gap-4 rounded-2xl px-3 transition hover:bg-[#f3f0e3]">
                <span className="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-[#e6edcf] text-[#184d39]"><Phone size={19} /></span>
              ...
              <a href={`mailto:${shop.email}`} className="focus-ring flex min-h-14 items-center gap-4 rounded-2xl px-3 transition hover:bg-[#f3f0e3]">
                <span className="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-[#e6edcf] text-[#184d39]"><Mail size={19} /></span>
              ...
              <a href={shop.map_url} target="_blank" rel="noreferrer" className="focus-ring flex min-h-14 items-start gap-4 rounded-2xl px-3 py-3 transition hover:bg-[#f3f0e3]">
                <span className="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-[#e6edcf] text-[#184d39]"><MapPin size={19} /></span>
              ...
              <div className="flex min-h-14 items-center gap-4 rounded-2xl px-3">
                <span className="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-[#e6edcf] text-[#184d39]"><Clock3 size={19} /></span>
