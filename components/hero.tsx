    ...
    <section id="top" className="paper-texture overflow-hidden border-b border-[#d7d1bf]">
      <div className="container-shell grid min-h-[calc(100svh-76px)] items-center gap-10 py-12 lg:grid-cols-[1.08fr_.92fr] lg:py-16">
        <div className="max-w-3xl">
          <div className="mb-7 inline-flex items-center gap-2 rounded-full border border-[#cfd6b0] bg-[#c7db95] px-4 py-2 text-sm font-semibold text-[#184d39]">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <Link
              href="/menu"
              className="focus-ring inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-[#184d39] px-6 font-semibold text-white transition hover:-translate-y-0.5 hover:bg-[#184d39]"
            >
              Xem menu hôm nay
            ...
            <Link
              href="/contact"
              className="focus-ring inline-flex min-h-12 items-center justify-center rounded-full border border-[#bfc9ae] bg-white/60 px-6 font-semibold text-[#184d39] transition hover:bg-white"
            >
              Liên hệ đặt bánh
            </Link>
          </div>
        ...
        <div className="relative mx-auto w-full max-w-[31rem] lg:justify-self-end">
          ...
          <div className="leaf-shadow soft-grid relative aspect-[4/5] overflow-hidden rounded-[3rem] border border-[#d5ccb9] bg-[#c7db95] p-7 sm:p-10">
            ...
            <span className="absolute bottom-5 right-5 rounded-full bg-[#184d39] px-4 py-2 text-xs font-bold uppercase tracking-[0.14em] text-white">
              made with care
            </span>
          </div>
        </div>
