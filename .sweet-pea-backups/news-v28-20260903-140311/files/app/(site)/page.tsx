...
function ProductImage({ product }: { product: HomeProduct }) {
    ...
    return (
      <div className="soft-grid grid aspect-[4/3] w-full place-items-center bg-[#eef0df] p-8">
        <div className="text-center text-[#5d735f]">
          <span className="mx-auto grid h-12 w-12 place-items-center rounded-full border border-[#d7cfba] bg-[#fffaf1]">
            <ImageIcon size={20} />
          </span>
  ...
  return (
    <div className="flex aspect-[4/3] w-full items-center justify-center bg-[#f3eee3] p-2 sm:p-3">
...
export default async function Home() {
  ...
  return (
    <PageTransition>
      <section className="relative overflow-hidden border-b border-[#d9d1c0] bg-[#f8f2e6]">
        <div className="pointer-events-none absolute -left-36 top-16 h-72 w-72 rounded-full bg-[#dce7bd]/55 blur-3xl" />
        ...
        <div className="container-shell relative grid gap-10 py-10 sm:py-14 lg:grid-cols-[0.88fr_1.12fr] lg:items-center lg:gap-14 lg:py-16 xl:py-20">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 rounded-full border border-[#cfdaad] bg-[#eef2d8] px-4 py-2 text-xs font-bold uppercase tracking-[0.14em] text-[#315d48] sm:text-sm">
              <Sparkles size={15} />
            ...
            <h1
              style={headingFont}
              className="mt-6 text-[clamp(3.4rem,7vw,6.6rem)] font-bold leading-[0.9] tracking-[-0.055em] text-[#194d39]"
            >
              Một góc xanh,
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link
                href="/menu"
                className="focus-ring inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-[#205942] px-6 font-bold text-white shadow-[0_12px_30px_rgba(32,89,66,0.18)] transition hover:-translate-y-0.5 hover:bg-[#173f30]"
              >
                Khám phá menu <ArrowRight size={18} />
              </Link>
              <Link
                href="/about"
                className="focus-ring inline-flex min-h-12 items-center justify-center gap-2 rounded-full border border-[#cfc5b2] bg-[#fffaf1]/80 px-6 font-bold text-[#205942] transition hover:bg-white"
              >
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-3">
              <div className="rounded-[1.4rem] border border-[#ddd4c3] bg-white/55 p-4 backdrop-blur-sm">
                ...
                <p className="mt-1 text-sm font-bold text-[#214e3d]">{data.shop.opening_text}</p>
              </div>
              <div className="rounded-[1.4rem] border border-[#ddd4c3] bg-white/55 p-4 backdrop-blur-sm">
                ...
                <p className="mt-1 text-sm font-bold text-[#214e3d]">Bánh & nước mới</p>
              </div>
              <div className="rounded-[1.4rem] border border-[#ddd4c3] bg-white/55 p-4 backdrop-blur-sm">
                <Leaf size={18} className="text-[#66885d]" />
                <p className="mt-2 text-xs font-bold uppercase tracking-[0.13em] text-[#7a877e]">Không gian</p>
                <p className="mt-1 text-sm font-bold text-[#214e3d]">Sân vườn xanh mát</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid min-w-0 grid-cols-5 gap-3 sm:gap-4">
            ...
            <div className="col-span-5 flex items-center justify-between gap-4 rounded-[1.5rem] border border-[#d8cfbd] bg-[#fffaf1] px-4 py-3 text-sm text-[#596a60] sm:col-span-2 sm:block sm:px-5 sm:py-5">
              <div className="flex items-center gap-2 font-bold text-[#245943]">
        ...
        <div className="container-shell">
          <div className="flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
            <div className="max-w-2xl">
              ...
              <h2 style={headingFont} className="mt-3 text-4xl font-bold tracking-[-0.04em] text-[#214e3d] sm:text-5xl lg:text-6xl">
            ...
            <Link href="/menu" className="focus-ring inline-flex w-fit items-center gap-2 rounded-full border border-[#d5ccbb] bg-[#faf6ed] px-5 py-3 text-sm font-bold text-[#245943] transition hover:bg-white">
          ...
          {selectedProducts.length ? (
            <div className="mt-9 grid gap-5 sm:grid-cols-2 xl:grid-cols-3">
              {selectedProducts.map((product) => (
                <article key={product.key} className="group overflow-hidden rounded-[2rem] border border-[#ddd5c5] bg-[#fffdf8] shadow-[0_16px_40px_rgba(54,72,60,0.06)] transition hover:-translate-y-1 hover:shadow-[0_24px_55px_rgba(54,72,60,0.11)]">
                  ...
                  <div className="p-5 sm:p-6">
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        ...
                        <h3 style={headingFont} className="mt-2 text-2xl font-bold leading-tight text-[#214e3d]">{product.name}</h3>
                      </div>
                      <span className="shrink-0 rounded-full bg-[#e8eed3] px-3 py-1.5 text-sm font-extrabold text-[#245943]">
                    ...
                    <div className="mt-5 flex items-center justify-between border-t border-dashed border-[#ddd3c1] pt-4">
                      ...
                      <Link href="/menu" className="focus-ring inline-flex items-center gap-1 text-sm font-bold text-[#245943]">
            ...
            <div className="mt-9 rounded-[2rem] border border-dashed border-[#d7cfbf] bg-[#f7f2e9] p-10 text-center text-[#66766c]">
        ...
        <div className="container-shell">
          <div className="grid gap-8 lg:grid-cols-[0.72fr_1.28fr] lg:items-end">
            <div className="max-w-xl">
              ...
              <h2 style={headingFont} className="mt-3 text-4xl font-bold tracking-[-0.04em] text-[#214e3d] sm:text-5xl">
              ...
              <Link href="/about" className="focus-ring mt-7 inline-flex items-center gap-2 rounded-full bg-[#245943] px-5 py-3 text-sm font-bold text-white">
      ...
      <section className="bg-[#fffdf8] py-16 sm:py-20 lg:py-24">
        <div className="container-shell">
          <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
            <div>
              <p className="text-xs font-bold uppercase tracking-[0.18em] text-[#718a68]">Bản tin Sweet Pea</p>
              <h2 style={headingFont} className="mt-3 text-4xl font-bold tracking-[-0.04em] text-[#214e3d] sm:text-5xl">Chuyện mới từ căn bếp.</h2>
            </div>
            <Link href="/news" className="focus-ring inline-flex w-fit items-center gap-2 text-sm font-bold text-[#245943]">Xem tất cả <ArrowRight size={17} /></Link>
          </div>

          <div className="mt-9 grid gap-5 lg:grid-cols-2">
            {news.slice(0, 2).map((post, index) => (
              <article key={post.id} className="overflow-hidden rounded-[2rem] border border-[#ddd5c5] bg-[#fffaf2]">
                ...
                <div className="p-5 sm:p-7">
                  ...
                  <h3 style={headingFont} className="mt-3 text-2xl font-bold leading-tight text-[#214e3d] sm:text-3xl">
                    <Link href={`/news/${post.id}`}>{post.title}</Link>
                  </h3>
                  <p className="mt-3 line-clamp-2 text-sm leading-7 text-[#6b796f]">{post.excerpt}</p>
                  <Link href={`/news/${post.id}`} className="focus-ring mt-5 inline-flex items-center gap-2 text-sm font-bold text-[#245943]">Đọc bản tin <ArrowRight size={16} /></Link>
                </div>
              </article>
            ))}
          </div>
      ...
      <section className="bg-[#174c39] py-14 text-white sm:py-16 lg:py-20">
        <div className="container-shell grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.18em] text-[#cfdda9]">Sweet Pea · Since 2022</p>
          ...
          <div className="flex flex-col gap-3 sm:flex-row lg:flex-col xl:flex-row">
            <a href={phoneHref} className="focus-ring inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-[#e8edcf] px-6 font-bold text-[#214e3d]">
