...
export function MenuCatalog({ categories, items }: { categories: MenuCategory[]; items: MenuItem[] }) {
    ...
    <section id="menu" className="bg-[#fffdf8] py-20 sm:py-24">
      <div className="container-shell">
        <div className="flex flex-col justify-between gap-7 lg:flex-row lg:items-end">
          <div>
            <p className="text-sm font-bold uppercase tracking-[0.18em] text-[#77906d]">Menu Sweet Pea</p>
            <h2 className="font-display mt-3 max-w-2xl text-4xl font-semibold tracking-[-0.045em] text-[#214e3d] sm:text-6xl">
              Món xinh cho ngày dịu dàng
            </h2>
          </div>
          <p className="max-w-md text-base leading-7 text-[#68766e]">
            Giá và tình trạng món được cập nhật trực tiếp. Nhắn tiệm để giữ phần bánh bạn thích nhé.
          </p>
        </div>

        <div className="mt-9 flex gap-2 overflow-x-auto pb-2" role="tablist" aria-label="Lọc menu theo danh mục">
