...
export default async function ContactPage() {
  ...
  return (
    <PageTransition>
      ...
      <section className="bg-[#e4eacb] py-16 sm:py-20">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {contacts.map(({ icon: Icon, label, value, href }) => (
              <a
                ...
                className="focus-ring rounded-[2rem] border border-[#cad3a9] bg-[#fffdf8] p-6 transition hover:-translate-y-1 hover:shadow-lg"
              >
                <span className="grid h-12 w-12 place-items-center rounded-2xl bg-[#e5ebca] text-[#245943]">
                  <Icon size={21} />
                </span>
                <small className="mt-7 block text-xs font-bold uppercase tracking-[0.14em] text-[#829078]">{label}</small>
                <strong className="mt-2 block break-words text-base leading-7 text-[#214e3d]">{value}</strong>
              </a>
            ))}
          </div>

          <div className="rounded-[2.5rem] bg-[#245943] p-7 text-white sm:p-9">
            <span className="grid h-12 w-12 place-items-center rounded-2xl bg-[#dfe9bd] text-[#245943]">
              <Clock3 size={22} />
            </span>
            <p className="mt-10 text-sm font-bold uppercase tracking-[0.16em] text-[#cedba9]">Thời gian nhận đơn</p>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="focus-ring mt-8 inline-flex min-h-12 items-center justify-center rounded-full bg-[#e4eacb] px-6 font-semibold text-[#214e3d]"
            >
              Nhắn Zalo ngay
            </a>
          </div>
        ...
        <div className="container-shell">
          <div className="mb-7 flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
            <div>
              ...
              <h2 className="font-display mt-3 text-4xl font-bold leading-tight text-[#214e3d] sm:text-5xl">Đường đến tiệm</h2>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="focus-ring inline-flex min-h-11 w-fit items-center gap-2 rounded-full border border-[#c8cfaf] bg-[#eef2d8] px-5 text-sm font-bold text-[#245943] transition hover:bg-[#e4eacb]"
            >
              <Navigation size={17} />
              Mở Google Maps
            </a>
