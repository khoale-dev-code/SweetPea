...
export default async function AboutPage() {
  ...
  return (
    <PageTransition>
      <main className="overflow-hidden bg-[#fbf7ee] text-[#1d4638]">
        <section className="relative border-b border-[#ded5c5]">
          ...
          <div className="container-shell relative grid min-h-[640px] gap-10 py-12 sm:py-16 lg:grid-cols-[0.82fr_1.18fr] lg:items-center lg:gap-14 lg:py-20">
            <div className="relative z-10 max-w-2xl">
              <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#d4d9b5] bg-[#eef1d9]/90 px-4 py-2 text-[11px] font-extrabold uppercase tracking-[0.2em] text-[#617b60] sm:text-xs">
                <Leaf size={15} />
                Về Sweet Pea
              </div>

              <h1 className="font-display text-5xl font-bold leading-[0.98] text-[#174a39] sm:text-6xl lg:text-7xl xl:text-[5.25rem]">
                Một góc vườn nhỏ,
                <span className="mt-2 block text-[#2b5b48]">nhiều điều dịu dàng.</span>
              </h1>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <a
                  href="#khong-gian"
                  className="focus-ring inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-[#215a43] px-6 text-sm font-bold text-white shadow-[0_14px_35px_rgba(33,90,67,.2)] transition hover:-translate-y-0.5 hover:bg-[#174a39]"
                >
                  Khám phá không gian
                  <Leaf size={17} />
                </a>
                <Link
                  href="/menu"
                  className="focus-ring inline-flex min-h-12 items-center justify-center gap-2 rounded-full border border-[#cfc5b5] bg-white/70 px-6 text-sm font-bold text-[#285443] transition hover:border-[#9faf86] hover:bg-white"
                >
                  Xem menu
                  <ArrowRight size={17} />
                </Link>
            ...
            <div className="relative min-h-[430px] sm:min-h-[520px] lg:min-h-[590px]">
              <div className="absolute -left-4 top-8 z-20 hidden rounded-[1.4rem] border border-white/70 bg-[#fffdf8]/92 p-4 shadow-[0_18px_50px_rgba(38,64,50,.16)] backdrop-blur sm:block lg:-left-10">
                <span className="grid h-10 w-10 place-items-center rounded-full bg-[#e4ecc4] text-[#245943]">
                  <Leaf size={18} />
                </span>
                <p className="mt-3 text-xs font-extrabold uppercase tracking-[0.16em] text-[#7a8b6f]">Sân vườn</p>
                <p className="mt-1 max-w-[150px] text-sm font-semibold leading-6 text-[#244c3c]">
              ...
              <div className="absolute inset-0 overflow-hidden rounded-[2rem] border border-[#d9cfbd] bg-[#e8e2d5] shadow-[0_30px_80px_rgba(43,73,58,.18)] sm:rounded-[2.6rem]">
                ...
                />
                <div className="absolute inset-x-0 bottom-0 h-36 bg-gradient-to-t from-[#173d31]/55 to-transparent" />
        ...
        <section className="bg-[#fffdf8] py-16 sm:py-20 lg:py-24">
          <div className="container-shell grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-14">
            <div>
              ...
              <h2 className="font-display mt-4 text-4xl font-bold leading-tight text-[#1c4b3a] sm:text-5xl">
        ...
        <section className="border-y border-[#ded5c5] bg-[#f4efe3] py-12 sm:py-16">
          <div className="container-shell grid gap-4 md:grid-cols-3">
            {highlights.map(({ icon: Icon, title, text }) => (
              <article
                key={title}
                className="group rounded-[2rem] border border-[#dcd2c1] bg-[#fffdf8] p-6 shadow-[0_12px_35px_rgba(40,66,52,.06)] transition hover:-translate-y-1 hover:shadow-[0_22px_50px_rgba(40,66,52,.1)] sm:p-7"
              >
                <span className="grid h-12 w-12 place-items-center rounded-full border border-[#d0dab1] bg-[#edf1d9] text-[#245943] transition group-hover:rotate-[-6deg]">
                  <Icon size={21} />
                </span>
                <h3 className="font-display mt-6 text-2xl font-bold text-[#1f4e3c]">{title}</h3>
        ...
        <section id="khong-gian" className="bg-[#fffdf8] py-16 sm:py-20 lg:py-24">
          <div className="container-shell">
            <div className="mb-8 flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
              <div>
                <p className="text-xs font-extrabold uppercase tracking-[0.2em] text-[#7b906f]">Một vòng quanh tiệm</p>
                <h2 className="font-display mt-3 text-4xl font-bold text-[#1c4b3a] sm:text-5xl">Không gian tại Sweet Pea</h2>
              </div>
            ...
            <div className="grid auto-rows-[220px] grid-cols-2 gap-3 sm:auto-rows-[280px] sm:gap-4 lg:grid-cols-12 lg:auto-rows-[260px]">
              {gallery.map((image, index) => (
                ...
                >
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#15372b]/20 via-transparent to-transparent opacity-70" />
                </figure>
              ))}
            </div>
          </div>
        ...
        <section className="bg-[#fffdf8] pb-16 sm:pb-20 lg:pb-24">
          <div className="container-shell">
            <div className="relative min-h-[280px] overflow-hidden rounded-[2rem] border border-[#cfc6b7] sm:min-h-[340px] sm:rounded-[2.5rem]">
              ...
              />
              <div className="absolute inset-0 bg-[#14372c]/55" />
              <div className="absolute inset-0 flex items-center justify-center p-6 text-center text-white">
                <div className="max-w-3xl">
                  <Coffee className="mx-auto text-[#e5e9c8]" size={28} />
        ...
        <section className="border-t border-[#ded5c5] bg-[#f3eee1] py-10 sm:py-12">
          <div className="container-shell grid gap-3 lg:grid-cols-[1fr_1.2fr_1.25fr]">
            <div className="flex items-start gap-4 rounded-[1.5rem] bg-white/55 p-5 sm:p-6">
              <span className="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-[#e5ebca] text-[#245943]">
                <Clock3 size={20} />
              </span>
              <div>
                <p className="text-xs font-extrabold uppercase tracking-[0.14em] text-[#7b8a73]">Mở cửa</p>
                <p className="mt-1 font-display text-xl font-bold text-[#214e3d]">{shop.opening_text || "Mở cửa mỗi ngày"}</p>
            ...
            <div className="flex items-start gap-4 rounded-[1.5rem] bg-white/55 p-5 sm:p-6">
              ...
              <div>
                ...
                <p className="mt-1 font-display text-xl font-bold text-[#214e3d]">Trong nhà &amp; sân vườn</p>
                <p className="mt-1 text-xs leading-5 text-[#738077]">Có nhiều góc ngồi phù hợp đi một mình, đi đôi hoặc nhóm nhỏ.</p>
              </div>
            </div>

            <div className="flex flex-col justify-between gap-5 rounded-[1.5rem] bg-[#215a43] p-5 text-white sm:flex-row sm:items-center sm:p-6 lg:flex-col lg:items-start xl:flex-row xl:items-center">
              <div className="flex min-w-0 items-start gap-4">
                <span className="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-white/12 text-[#e8edcd]">
                  <MapPin size={20} />
                </span>
                <div className="min-w-0">
                  <p className="text-xs font-extrabold uppercase tracking-[0.14em] text-[#d1ddb2]">Chúng tôi ở đây</p>
                  <p className="mt-1 line-clamp-2 text-sm font-semibold leading-6 text-white/90">{shop.address}</p>
                </div>
              </div>
              <Link
                href="/contact"
                className="focus-ring inline-flex min-h-11 shrink-0 items-center justify-center gap-2 rounded-full bg-[#eff2dc] px-5 text-sm font-bold text-[#245943] transition hover:bg-white"
              >
                Xem đường đi
                <ArrowRight size={16} />
              </Link>
