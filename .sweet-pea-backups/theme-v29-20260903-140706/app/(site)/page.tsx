        ...
        <div className="container-shell">
          <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
            <div>
              ...
              <h2 style={headingFont} className="mt-3 text-4xl font-bold tracking-[-0.04em] text-[#214e3d] sm:text-5xl">{featuredNews.length ? "Tiệm đang muốn kể bạn nghe." : "Chuyện mới từ căn bếp."}</h2>
            </div>
