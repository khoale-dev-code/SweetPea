    ...
    <header className="sticky top-0 z-50 border-b border-[#d7d1bf]/80 bg-[#fffced]/92 backdrop-blur-xl">
      <div className="container-shell flex h-[76px] items-center justify-between gap-5">
        ...
        <div className="flex items-center gap-2">
          <a
            href={`tel:${tel}`}
            className="focus-ring hidden min-h-11 items-center gap-2 rounded-full bg-[#184d39] px-5 text-sm font-semibold text-white transition hover:bg-[#184d39] sm:inline-flex"
          >
