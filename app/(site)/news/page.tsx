...
function NewsPreview({ post, compact = false }: { post: NewsPost; compact?: boolean }) {
    ...
    <div className="relative h-full w-full">
      {cover.type === "video" ? (
        <>
          ...
          <span className="absolute inset-0 grid place-items-center bg-[#184d39]/15 text-white"><span className="grid h-10 w-10 place-items-center rounded-full bg-[#184d39]/80"><Play size={17} fill="currentColor" /></span></span>
        </>
      ) : (
        ...
        <div className="container-shell relative grid gap-8 py-10 sm:py-14 lg:grid-cols-[1fr_0.9fr] lg:items-center lg:gap-12 lg:py-16">
          <div className="max-w-2xl">
            ...
            <div className="mt-7 flex flex-wrap gap-3 text-sm font-semibold text-[#184d39]/70">
              ...
              <span className="inline-flex items-center gap-2 rounded-full border border-[#184d39]/10 bg-white/65 px-4 py-2.5"><Images size={16} /> Ảnh · GIF · Video</span>
            </div>
          </div>
